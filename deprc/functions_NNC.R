...
c.update1 <-  cxxfunction(
  signature(Xitm1="numeric",DIMS="integer",TUNEX="numeric",Yy="numeric",BETAIN="numeric",BETAOUT="numeric",TUNEBIO="numeric", WW="numeric",t2X="numeric",s2X="numeric",
            xiBIN="numeric",xiBOUT="numeric",nuBIN="numeric",
            nuBOUT="numeric",CAUCHY="integer",
            RNORMS="numeric",RNORMSBIO="numeric", Gamma = "numeric"),
  body='
/*Dims is c(n,p,TT,K)
  Z nxT; X pxTxn; Y pxpxT; 
  */
  ...
  for(int i=0;i<dims(0);i++)
{
  ...
  double g2 = Rcpp::as<double>(Gamma);
...
c.GammaAccProb1 <-  cxxfunction(
  signature(Data="numeric",DIMS="integer",Yy="numeric",
            BETAIN="numeric",BETAOUT="numeric",alpha="numeric",beta = "numeric",
            WW="numeric",Gamma="numeric", GammaNew = "numeric"),
  body='
/*Dims is c(n,p,TT,K)
  Z nxT; X pxTxn; Y pxpxT; 
  */
  ...
  double BOUT = Rcpp::as<double>(BETAOUT);
  double g2 = Rcpp::as<double>(Gamma);
  double g2new = Rcpp::as<double>(GammaNew);
  double alph = Rcpp::as<double>(alpha);
  double bta = Rcpp::as<double>(beta);
...
c.WAccProb1 <-  cxxfunction(
  signature(Data="numeric",DIMS="integer",Yy="numeric",
            ...
            WWOld="numeric",WWNew="numeric", Gamma = "numeric"),
  body='
/*Dims is c(n,p,TT,K)
  Z nxT; X pxTxn; Y pxpxT; 
  */
